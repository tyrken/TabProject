...
var Hack1 = (function (TPM) {
  var my = {};

  my.showVars = function () {
  ...
  if (!TPM.get("blocklist")) {
      TPM.put("blocklist", JSON.stringify(my.blockTheseSites));
  }

  my.getBlockedSites = function () {
      return JSON.parse(TPM.get("blocklist"));
  }

  my.getWatchThisInstead = function () {
      return TPM.get("instead");        
  }

  my.addBlockedSite = function (site) {
      my.blockedSites = JSON.parse(TPM.get("blocklist"));
      my.blockedSites[site] = "Custom Add";
      TPM.put("blocklist", JSON.stringify(my.blockedSites));
  }
